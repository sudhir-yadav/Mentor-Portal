                                        ...
                                        <tr>
                                            <td>
                                                   <label class="cstm_form_label">NAME :</label>
                                                     <input type="text" value="Sudhir"  class="cstm_input" placeholder="">  

                                                    <!-- <label class="cstm_form_label">NAME :</label>
                                                    <input class="cstm_input" placeholder="" value="Sudhir"> -->
                                            ...
                                            <td>
                                                    ...
                                                    <!-- <label class="cstm_form_label">MIDDLE NAME :</label>
                                                    <input class="cstm_input" placeholder="" value="Mohan"> -->
                                             ...
                                             <td>
                                                  ...
                                                  <label class="cstm_form_label">SURNAME :</label>
                                                   ...
                                                   <!--  <label class="cstm_form_label">SURNAME :</label>
                                                    <input class="cstm_input" placeholder="" value="Yadav"> -->
                                                   <!--  <p class="help-block">Example block-level help text here.</p> -->
                                            </td>
                                        </tr>
